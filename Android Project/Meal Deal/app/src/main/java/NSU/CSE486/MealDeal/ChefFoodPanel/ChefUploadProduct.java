...
public class ChefUploadProduct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chef_upload_product);
    ...
    private void uploadImage() {
        ...
        if(imageuri != null){
            final ProgressDialog progressDialog = new ProgressDialog(ChefUploadProduct.this);
            ...
            ref.putFile(imageuri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            firebaseDatabase.getInstance().getReference("FoodDetails").child(State).child(City).child(Area).child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(RandomUID)
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    ...
                                    Toast.makeText(ChefUploadProduct.this,"Product Uploaded Successfully!",Toast.LENGTH_SHORT).show();
                                }
                            });
                ...
                public void onFailure(@NonNull Exception e) {
                    progressDialog.dismiss();
                    Toast.makeText(ChefUploadProduct.this,e.getMessage(),Toast.LENGTH_SHORT).show();
                }
