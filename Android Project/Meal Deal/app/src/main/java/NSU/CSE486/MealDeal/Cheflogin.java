    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if(task.isSuccessful()){
                                    ...
                                    if(Fauth.getCurrentUser().isEmailVerified()){
                                        ...
                                        CommonCodeBase.ShowAlert(Cheflogin.this,"Verification Failed","You Have Not Verified Your Email");

                                    }
                                }else{
                                    mDialog.dismiss();
                                    CommonCodeBase.ShowAlert(Cheflogin.this,"Error",task.getException().getMessage());
                                }
                            }
                        });
                    }
            ...
            Forgotpassword.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    startActivity(new Intent(Cheflogin.this,ChefForgetPassword.class));
                    finish();
                }
            });
