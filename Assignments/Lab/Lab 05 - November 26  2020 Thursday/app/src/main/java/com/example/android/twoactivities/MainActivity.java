...
public class MainActivity extends AppCompatActivity {
            ...
            if (itemsList != null && itemsList.size() > 0) {
                for (i = 0; i < itemsList.size(); i++) {
                    if (itemsList.size() > 10) {
                        Toast.makeText(MainActivity.this, "You can't add any additional item!", Toast.LENGTH_LONG).show();
                        break;
                    }
    ...
    public void addItem(View view) {
        Intent intent = new Intent(this, com.example.android.twoactivities.SecondActivity.class);
    ...
    public void searchStores(View view) {
        ...
        if (intent.resolveActivity(getPackageManager()) != null) {
            ...
            Toast.makeText(MainActivity.this, "No store found!", Toast.LENGTH_LONG).show();
        }
    }
}
